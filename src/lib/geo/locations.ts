...
const LOCATIONS: Record<string, LocationConfig> = {
  ...
  istanbul: {
    city: { name: "Istanbul", slug: "istanbul", lat: 41.0082, lon: 28.9784 },
    country: { name: "Türkiye", slug: "turkiye", lat: 38.9637, lon: 35.2433 },
    locale: "tr-TR",
    timezone: "Europe/Istanbul",
    pbfUrl: "https://download.bbbike.org/osm/bbbike/Istanbul/Istanbul.osm.pbf",
    pbfFilename: "Istanbul.osm.pbf",
    seedRadius: -1,
  },
};
