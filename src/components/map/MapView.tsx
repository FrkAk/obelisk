 ...
 *
 * @param children - Child components to render inside the map (markers, etc).
 * @param onMoveEnd - Callback fired when map movement ends with new center coordinates.
 * @param onViewStateChange - Callback with zoom and bounds on viewport change.
 * @param onPoiClick - Callback when a POI feature is clicked.
 * @param onMapClick - Callback when the map background is clicked.
 * @param initialCenter - Initial map center coordinates.
 * @param initialZoom - Initial zoom level.
 * @param userLocation - Current user location for centering.
 * @param flyToLocation - Location to fly to with timestamp for dedup.
 */
